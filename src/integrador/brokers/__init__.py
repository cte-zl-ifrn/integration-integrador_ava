...
class MoodleBroker:
    ...
    def __get_coortes(self) -> list:
        ...
        try:
            curso, created = Curso.objects.get_or_create(
                suap_id=self.solicitacao.recebido["curso"]["id"],
                codigo=self.solicitacao.recebido["curso"]["codigo"],
                nome=self.solicitacao.recebido["curso"]["nome"],
                descricao=self.solicitacao.recebido["curso"]["descricao"],
            )
            if created:
    ...
    def sync_down_grades(self, solicitacao: Solicitacao) -> dict:
