...
No SUAP um curso é formado por vários componentes currículares que são ofertados em períodos na forma de turmas, isto gera um **código de diário**, o qual é formado pela concateção do **código da turma** e pelo **código do componente currícular**, separados por ".", mais o **ID do diário**. No exemplo onde o código do diário seja "`20212.1.011001.1P`.**FIC007**#<u>123456</u>":
