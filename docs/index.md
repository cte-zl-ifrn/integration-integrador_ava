...
**Referência completa:** [docs/suap2local_suap/](suap2local_suap/)
...
**Referência:** [docs/suap2tool_sga/](suap2tool_sga/)
...
**Plugin necessário:** [`tool_sga`](https://github.com/cte-zl-ifrn/moodle-tool_sga)
**Referência:** [docs/sga2tool_sga/](sga2tool_sga/)
...
Guia completo do admin: [docs/admin/](admin/)
...
| Seção                              | Conteúdo                                                      |
|------------------------------------|---------------------------------------------------------------|
| [Modelos de dados](model/)         | `Ambiente`, `Solicitacao` — campos, comportamentos, manager   |
| [Guia do administrador](admin/)    | Django admin: Ambientes, Solicitações, Cohorts                |
| [Broker suap2local_suap](suap2local_suap/) | API completa: endpoints, payload, stack de decorators |
| [Broker suap2tool_sga](suap2tool_sga/)     | Em elaboração                                         |
| [Broker sga2tool_sga](sga2tool_sga/)       | Em elaboração                                         |
| [Guia de testes](tests/)           | TestCases, receitas QA, cobertura, mock HTTP                  |
...
- [README do projeto](../README.md) — instalação, desenvolvimento, CI/CD
- [`requests.http`](../requests.http) — exemplos prontos de requisição REST
